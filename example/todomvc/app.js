...
var content = __webpack_require__(/*! !../node_modules/css-loader??ref--4-1!./app.css */ "./node_modules/css-loader/index.js??ref--4-1!./css/app.css");
...
var _valuelink = __webpack_require__(/*! valuelink */ "./node_modules/valuelink/lib/index.js");
...
var AddTodo = function (_LinkedComponent) {
    _inherits(AddTodo, _LinkedComponent);
    ...
    function AddTodo() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, _LinkedComponent.call.apply(_LinkedComponent, [this].concat(args))), _this), _this.state = {
            desc: ""
    ...
    AddTodo.prototype.render = function render() {
        return _react2.default.createElement(
            ...
            _react2.default.createElement('input', _extends({ className: 'new-todo', placeholder: 'What needs to be done?', autoFocus: true
...
var _todolist = __webpack_require__(/*! ./todolist.jsx */ "./js/todolist.jsx");

var _todolist2 = _interopRequireDefault(_todolist);

var _filter = __webpack_require__(/*! ./filter.jsx */ "./js/filter.jsx");

var _filter2 = _interopRequireDefault(_filter);

var _addtodo = __webpack_require__(/*! ./addtodo.jsx */ "./js/addtodo.jsx");
...
var App = function (_LinkedComponent) {
    ...
    App.prototype.getActiveCount = function getActiveCount() {
        return this.state.todos.reduce(function (count, x) {
    ...
    App.prototype.componentWillMount = function componentWillMount() {
        ...
        window.onunload = function () {
            ...
            localStorage.setItem('todo-mvc', JSON.stringify(_this2.state));
        };
    };

    App.prototype.render = function render() {
        var links = this.linkAll(),
            _state = this.state,
            todos = _state.todos,
            filterDone = _state.filterDone,
        ...
        return _react2.default.createElement(
            ...
            _react2.default.createElement(
                'section',
                { className: 'todoapp' },
                _react2.default.createElement(_addtodo2.default, { onEnter: function onEnter(desc) {
                        return links.todos.push({ done: false, desc: desc });
                    } }),
                hasTodos && _react2.default.createElement(_todolist2.default, { todosLink: links.todos,
                    filterDone: filterDone
                }),
                hasTodos && _react2.default.createElement(_filter2.default, { count: this.getActiveCount(),
...
var _proptypes = __webpack_require__(/*! proptypes */ "./node_modules/proptypes/index.js");
...
var AllDoneLink = function (_Link) {
    _inherits(AllDoneLink, _Link);

    function AllDoneLink(todosLink) {
        _classCallCheck(this, AllDoneLink);

        var _this = _possibleConstructorReturn(this, _Link.call(this, todosLink.value.every(function (todo) {
            return todo.done;
        })));

        _this.parent = todosLink;
        return _this;
    }

    AllDoneLink.prototype.set = function set(x) {
        this.parent.update(function (todos) {
...
var TodoList = (_temp2 = _class = function (_LinkedComponent) {
    _inherits(TodoList, _LinkedComponent);
    ...
    function TodoList() {
        ...
        return _ret = (_temp = (_this2 = _possibleConstructorReturn(this, _LinkedComponent.call.apply(_LinkedComponent, [this].concat(args))), _this2), _this2.state = {
            editing: null
    ...
    TodoList.prototype.render = function render() {
        var _props = this.props,
            todosLink = _props.todosLink,
            filterDone = _props.filterDone,
            editingLink = _valuelink2.default.state(this, 'editing'),
            allDoneLink = new AllDoneLink(todosLink);

        return _react2.default.createElement(
            'section',
            { className: 'main' },
            _react2.default.createElement('input', _extends({ id: 'toggle-all', className: 'toggle-all', type: 'checkbox'
            }, allDoneLink.props)),
            _react2.default.createElement(
                'label',
                { htmlFor: 'toggle-all' },
            ...
            _react2.default.createElement(
                ...
                todosLink.map(function (todoLink, i) {
                    if (filterDone === null || filterDone === todoLink.value.done) {
                        return _react2.default.createElement(TodoItem, { key: i, todoLink: todoLink,
    ...
    return TodoList;
}(_valuelink.LinkedComponent), _class.propTypes = {
    todosLink: _proptypes2.default.instanceOf(_valuelink2.default),
    filterDone: _proptypes2.default.bool
}, _temp2);
...
var TodoItem = function TodoItem(_ref) {
    var todoLink = _ref.todoLink,
        editingLink = _ref.editingLink;
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            'div',
            { className: 'view' },
            _react2.default.createElement('input', _extends({ className: 'toggle', type: 'checkbox'
        ...
        editing && _react2.default.createElement('input', _extends({ className: 'edit'
...
/***/ "./node_modules/css-loader/index.js??ref--4-1!./css/app.css":
/*!*********************************************************!*\
...
_link__WEBPACK_IMPORTED_MODULE_1__["Link"].all = function (component) {
    var _keys = [];
...
_link__WEBPACK_IMPORTED_MODULE_1__["Link"].state = linkAt;
...
var StateLink = /** @class */ (function (_super) {
    ...
    return StateLink;
}(_link__WEBPACK_IMPORTED_MODULE_1__["Link"]));
...
/*!*********************************************!*\
  !*** ./node_modules/valuelink/lib/index.js ***!
  \*********************************************/
/*! exports provided: default, LinkedComponent, StateLink, Link, CustomLink, CloneLink, EqualsLink, EnabledLink, ContainsLink, LinkAt */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./helpers */ "./node_modules/valuelink/lib/helpers.js");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var Link = /** @class */ (function () {
    ...
    Link.prototype.push = function () {
        var array = _helpers__WEBPACK_IMPORTED_MODULE_0__["arrayHelpers"].clone(this.value);
    ...
    Link.prototype.map = function (iterator) {
        return Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["helpers"])(this.value).map(this, iterator);
    };
    Link.prototype.removeAt = function (key) {
        var value = this.value, _ = Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["helpers"])(value);
    ...
    Link.prototype.clone = function () {
        ...
        return Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["helpers"])(value).clone(value);
    };

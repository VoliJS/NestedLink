...
function (_Link) {
  ...
  function AllDoneLink(todosLink) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(AllDoneLink).call(this, todosLink.value.every(function (todo) {
      return todo.done;
    })));
  ...
  return AllDoneLink;
}(valuelink__WEBPACK_IMPORTED_MODULE_2__["default"]);

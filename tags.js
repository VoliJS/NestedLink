...
export function Input(props) {
    ...
    switch (type) {
        case 'checkbox':
            return React.createElement("input", __assign({}, rest, { checked: link.value, onChange: link.action(setBoolValue) }));
        case 'radio':
        ...
        default:
            return React.createElement("input", __assign({}, rest, { className: validationClasses(rest, valueLink.value, valueLink.error), value: valueLink.value, onChange: valueLink.action(setValue) }));
    }
}
;

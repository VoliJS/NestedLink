...
export declare abstract class Component<P, S> extends React.Component<P, S> implements DataBindingSource<S> {
    links: LinksCache<S>;
    linkAt<K extends keyof S>(key: K): Link<S[K]>;
...
export declare class StateLink<P, S, K extends keyof S> extends Link<S[K]> {
    ...
    key: K;
    constructor(component: Component<P, S>, key: K, value: S[K]);
    set(x: S[K]): void;
}
